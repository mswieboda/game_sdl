  ...
  class Box < Shape
    ...
    def update_geometry
      ...
      if rotation != 0 && draw_border_radius <= 0
        ...
        [
          { center: {render_x + draw_border_radius, render_y + draw_border_radius}, dir: {1_i8, 1_i8} },
          { center: {render_x + render_width - draw_border_radius, render_y + draw_border_radius}, dir: {-1_i8, 1_i8} },
          { center: {render_x + draw_border_radius, render_y + render_height - draw_border_radius}, dir: {1_i8, -1_i8} },
          { center: {render_x + render_width - draw_border_radius, render_y + render_height - draw_border_radius}, dir: {-1_i8, -1_i8} }
        ].each do |data|
    ...
    private def draw_outline_cross(draw : Draw)
      # top
      p1 = rotate_point(render_x + draw_border_radius, render_y)
      p2 = rotate_point(render_x + render_width - draw_border_radius, render_y)
      draw.line(p1[0], p1[1], p2[0], p2[1], color: color, z_index: z_index)

      # bottom
      p3 = rotate_point(render_x + draw_border_radius, render_y + render_height)
      p4 = rotate_point(render_x + render_width - draw_border_radius, render_y + render_height)
      draw.line(p3[0], p3[1], p4[0], p4[1], color: color, z_index: z_index)

      # left
      p5 = rotate_point(render_x, render_y + draw_border_radius)
      p6 = rotate_point(render_x, render_y + render_height - draw_border_radius)
      draw.line(p5[0], p5[1], p6[0], p6[1], color: color, z_index: z_index)

      # right
      p7 = rotate_point(render_x + render_width, render_y + draw_border_radius)
      p8 = rotate_point(render_x + render_width, render_y + render_height - draw_border_radius)
